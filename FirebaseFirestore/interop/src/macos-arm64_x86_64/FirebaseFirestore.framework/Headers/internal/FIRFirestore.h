 ...
 * @return The default `Firestore` instance.
 */
+ (instancetype)firestoreForApp:(FIRApp *)app NS_SWIFT_NAME
...
+ (instancetype)firestoreForApp:(FIRApp *)app
                       database:(NSString *)database NS_SWIFT_NAME
 ...
 * @return The named `Firestore` instance.
 */
+ (instancetype)firestoreForDatabase:(NSString *)database NS_SWIFT_NAME
...
(
setIndexConfiguration(_
:completion:)) DEPRECATED_MSG_ATTRIBUTE(
 ...
 */
- (FIRQuery *)collectionGroupWithID:(NSString *)collectionID NS_SWIFT_NAME
 ...
 */
- (FIRLoadBundleTask *)loadBundle:(NSData *)bundleData NS_SWIFT_NAME
 ...
 * completion or error events.
 */
- (FIRLoadBundleTask *)loadBundleStream:(NSInputStream *)bundleStream NS_SWIFT_NAME
